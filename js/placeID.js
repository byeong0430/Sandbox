...
autocomplete.addListener('place_changed', function() {
    ...
    */
    var prohibitType = "street_address";
    var checkProhibitType = $.inArray(prohibitType, place.types);
    
    //If you type a non-existing address, stop the code
    if (!place.geometry) {
        return;
    }else if (checkProhibitType >= 0) { 
        //If place.types contains "street_adress", create an alert message
